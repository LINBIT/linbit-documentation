...
image::images/drbd-resource-stacking-pacemaker-3nodes.svg[scaledwidth="100%"]
...
.DRBD resource stacking in Pacemaker clusters
image::images/drbd-resource-stacking-pacemaker-4nodes.svg[scaledwidth="100%"]
...
image::images/drbd-pacemaker-floating-peers.svg[scaledwidth="100%"]
