...
1. Configuring correct permissions for the `oneadmin` user
1. Creating a LINSTOR OpenNebula image datastore
1. Creating LINSTOR resource groups from which to deploy storage resources
1. Configuring optional LINSTOR plugin attributes
1. Configuring LINSTOR as an OpenNebula system datastore
