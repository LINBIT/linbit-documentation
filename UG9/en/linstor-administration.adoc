...
You can back up the LINSTOR controller's internal database by using the following command:

----
# linstor controller backupdb <backup_name>
----

This command creates a ZIP archive file of the LINSTOR controller database in the
