...
<<s-shipping_snapshots-l2l>> section for instructions on how to get your LINSTOR cluster's ID and create such a remote. An example command could look like this:
