...
NOTE: As mentioned in <<s-linstor-resource-groups>>, spawning resources from resource groups
should be the de facto way that you create LINSTOR resources. Creating resources from resource
definitions is described below for completeness and for use in special circumstances.
