...
By using the `--place-count <replica_count>` argument when you create or modify a resource group, you can specify on how many nodes in your cluster LINSTOR should place resources created from the resource group.
