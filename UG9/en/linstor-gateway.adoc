...
LINSTOR Gateway provides a utility to check that the prerequisite tools are present. To use this tool, enter the following command on your LINSTOR controller node:
