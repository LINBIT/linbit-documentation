...
* Now you can initialize your two SCSI partitions as PVs:
...
* Now you can create your Logical Volume to be used as DRBD's backing
...
* Next, edit your `/etc/drbd.conf` to create a new resource named `r0`:
  indexterm:[drbd.conf]
+
[source,drbd]
----
