...
+++<u>Available since LINSTOR v.0.9.13</u>+++:
...
resources with all their volumes in the so-called 'lost' storage pool are attached:
...
corresponding list-command (e.g. 'resource list'). After deleting the LINSTOR-objects in the lost storage pool
