...
delete the satellite, even if it is working as it should be. Should you wish to get rid of an evicted
node, you need to use the `node lost` command. The satellite can, however, be restored.
