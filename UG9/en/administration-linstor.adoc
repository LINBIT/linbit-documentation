...
Basically you create a certificate for you client and add it to your truststore and the client
than uses this certificate for authentication.
...
Than we import this certificate to our controller truststore:
...
keytool -importkeystore -srckeystore client.jks -destkeystore client.p12\
 -storepass linstor -keypass linstor\
 -srcalias client -srcstoretype jks -deststoretype pkcs12
