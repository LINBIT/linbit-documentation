...
everything.
+
NOTE: This guide assumes you are using version 1.0.0 of the operator. v1.0.0 is currently a release candidate, so
you need to add `--devel` to the `helm install` step.
+
----
