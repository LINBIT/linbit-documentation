...
IMPORTANT: If you are using a Kubernetes version more recent than 1.16, you will
also have to remove the `initializers:` key and its `pending: []` element. This
key has been deprecated since 1.13 and has been removed in 1.16.
...
IMPORTANT: As above, if you are using Kubernetes version 1.16 or newer, you will
also have to remove the `initializers:` key and its `pending: []` element. This
key has been deprecated since 1.13 and has been removed in 1.16.
