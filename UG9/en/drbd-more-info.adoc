...
https://www.linbit.com/[LINBIT] maintains an official https://x.com/linbit[X (formerly Twitter)
account].
...
- Philipp Reisner.
  https://web.archive.org/web/20150906225118/https://drbd.linbit.com/fileadmin/drbd/publications/drbd8_orig.pdf[DRBD
  v8 - Replicated Storage with Shared Disk Semantics], 2007.

- Philipp Reisner.
  https://web.archive.org/web/20150906225736/https://drbd.linbit.com/fileadmin/drbd/publications/drbd-activity-logging_v6.pdf[Rapid
  resynchronization for replicated storage], 2006.

// You can find many more on https://drbd.linbit.com/home/publications/.
