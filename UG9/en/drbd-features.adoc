...
radius of a service failure. Pacemaker has probably the most flexible system to express
resources location and ordering constraints. However, with this flexibility, setups can become
complex.
