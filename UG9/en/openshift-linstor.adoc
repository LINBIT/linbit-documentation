...
linstor-op-cs   linstor-op-cs-storage.apps.oc.example.com            linstor-cs   linstor-cs   edge            None
----

The GUI is now accessible at `+https://linstor-cs-storage.apps.oc.example.com/ui/+`
