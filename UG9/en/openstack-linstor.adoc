...
[DEFAULT]
...
default_volume_type = linstor-drbd
...
$ openstack volume type create default volume
+-------------+--------------------------------------+
| Field       | Value                                |
+-------------+--------------------------------------+
| description | None                                 |
...
[source,shell]
----
$ cinder get-capabilities cinder-01.openstack.test@linstor-drbd-cinderpool
+---------------------+------------------------------------------------------------------+
| Volume stats        | Value                                                            |
+---------------------+------------------------------------------------------------------+
| description         | None                                                             |
...
[source,shell]
----
openstack volume create --type linstor-drbd --size 1 --availability-zone nova linstor-test-vol
